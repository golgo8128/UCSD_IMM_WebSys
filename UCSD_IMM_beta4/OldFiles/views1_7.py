...
from Nephrology.MetabDatProc1.Rplot_batch_PDFout1_2 import invoke_Rplot_batch_PDFout
from Nephrology.MetabDatProc1.Metab_Batch_Adjust_SingleFile1_12 \
...
def entry(request):
    ...
    contxt = RequestContext(request,
                            { "fupobjs" : fupobjs })
    templt = loader.get_template("appBatchAdjust/proc_singlefile1_7.html")
...
def invoke(request):
    ...
    contxt = RequestContext(request,
                            { "PDFfile"  : BADJ_PDF_DIRURL.get_user_urlpath(opdf_bfilnam),
                              ...
                              "metabdetectlowlimit"  : metabdetectlowlimit,
    ...
    templt = loader.get_template("appBatchAdjust/badj_dl_links1_3.html")
...
def initiate(istamp,
    ...
    try:
        ...
        mbas = Metab_Batch_Adjust_SingleFile(
            ...
            calcmnfunc             = mn_func,
            detection_limit        = metabdetectlowlimit,
            smallval_for_zerosnans = smallvalforzerosnans,
            smallval_for_zerosnans_ctrl_only_mode = False,
        ...
        invoke_Rplot_batch_PDFout(imetab_bunc_batch_file = itsv_fpath, # imetabfile,
                                  ...
                                  add_small_quant_ctrl = smallvalforzerosnans,
                                  add_small_quant_act = smallvalforzerosnans)
