...
from Nephrology.MetabDatProc1.Rplot_batch_PDFout1_3 import invoke_Rplot_batch_PDFout
from Nephrology.MetabDatProc1.Metab_Batch_Adjust_SingleFile1_14 \
...
def entry(request):
    ...
    contxt = RequestContext(request,
                            { "fupobjs" : fupobjs })
    templt = loader.get_template("appBatchAdjust/proc_singlefile1_8.html")
